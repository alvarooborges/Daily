package br.com.kodeway.daily.util.time;
...
public enum TimeUtil {
    ...
    TimeUtil(long millis, String... formats) {
        this.millis = millis;
    ...
    public static Long getTime(String string) {
        ...
        while (matcher.find()) {
            try {
                ...
                TimeUtil type = fromFormats(matcher.group(2));
                if (type != null) {
    ...
    public static TimeUtil fromFormats(String format) {
